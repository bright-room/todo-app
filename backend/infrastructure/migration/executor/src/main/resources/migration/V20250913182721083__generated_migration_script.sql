...
CREATE TABLE IF NOT EXISTS task_due_date (id SERIAL PRIMARY KEY, task_id uuid NOT NULL, due_date TIMESTAMP NOT NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP NOT NULL, CONSTRAINT fk_task_due_date_task_id__id FOREIGN KEY (task_id) REFERENCES task_id(id) ON DELETE RESTRICT ON UPDATE RESTRICT);
...
CREATE SEQUENCE IF NOT EXISTS task_tag_id_seq START WITH 1 MINVALUE 1 MAXVALUE 9223372036854775807;
